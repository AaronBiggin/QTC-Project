...
class DasAtom:
    ...
    def _process_file(self, file_name):
        ...
        #patitions that can be executed with the same architecture
    
        embeddings, arch_size = self._get_embeddings(file_name, partition_gates, coupling_graph, num_q, arch_size)
         #intermediary function finds out the modified arch_size after coupling graph is extended
        # print("dag")
        # print(dag)
        # print("architecture size")
        # print(arch_size)
        # print("parition")
        # pprint(partition_gates)
        # print("embeddings")
        # pprint(embeddings)
...
#What this function does is finds parallel movements and non parallel and collates them together. Instead of having a list of qubit movements we think of them in terms of AOD trap movements. 
